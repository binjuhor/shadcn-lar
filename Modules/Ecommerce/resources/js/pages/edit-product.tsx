          ...
          <div className="grid flex-1 items-start gap-4 md:gap-8">
            <div className="grid flex-1 auto-rows-max gap-4">
                ...
                <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Update the basic information for your product</CardDescription>
                    </CardHeader>
                    <CardContent>
              ...
              <div className="flex items-center justify-center gap-2 md:hidden">
                ...
                <Button size="sm" onClick={() => handleSubmit()} disabled={processing}>{processing ? 'Updating...' : 'Update Product'}</Button>
              </div>
            </div>
          </div>
        </Main>
